...
/* igs_resource_msg_from_err("tmp",::GetLastError()) --> 実行結果例 --> "igs_resource_msg_from_err.cxx:58:_MSC_VER:150030729:2012:Jan:30:15:37:59" "int __cdecl main(int,char *[])" "tmp:指定されたモジュールが見つかりません。" */
/*--- エラーメッセージを得る ---*/
...
/* igs_resource_msg_from_er("tmp")                   --> 実行結果例 --> "igs_resource_msg_from_err.cxx:58:_MSC_VER:150030729:2012:Jan:30:15:37:59" "int __cdecl main(int,char *[])" "tmp" */
