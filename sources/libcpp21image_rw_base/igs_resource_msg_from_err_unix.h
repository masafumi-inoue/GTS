...
namespace igs {
 namespace resource {
  const std::string msg_from_err_( /* 直に呼ばない */
...
/* igs_resource_msg_from_err("tmp",errno) --> 実行結果例 --> "igs_resource_msg_from_err.cxx:86:__GNUC__:4.1.2-48:2012:Jan:30:15:36:27" "int main(int, char**)" "tmp:No such file or directory" */
/*--- エラーメッセージを得る ---*/
...
/* igs_resource_msg_from_er("tmp")        --> 実行結果例 --> "igs_resource_msg_from_err.cxx:86:__GNUC__:4.1.2-48:2012:Jan:30:15:36:27" "int main(int, char**)" "tmp" */
